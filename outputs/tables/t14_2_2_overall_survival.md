# Table 14.2.2 Key Secondary Efficacy Analysis: Overall Survival
...
* CNSR=0 denotes an event. Cox HR <1 favors ONC-305 + SOC.
* Median CI uses nonparametric bootstrap for portfolio demonstration.
